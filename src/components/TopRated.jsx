          ...
          <div className="grid grid-cols-4 gap-6 mx-8 mt-8 xsm:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
            {items.map((val) => {
              return (
                <div
                  key={val.id}
                  className="relative flex flex-col  items-center pt-4 bg-gray-600 rounded-xl hover:scale-110 duration-100 transition-all"
                >
                  ...
                  <button
                    ...
                    //   warning();
                    // }}
                    className="mt-4 border px-2 rounded-md bg-gray-200 text-gray-700 font-semibold"
                  >
                    Remove From Cart
                  </button>
                  {/* ) : ( */}
                  <button
                    ...
                    className="mt-4 border px-2 rounded-md 
                       bg-gray-200 text-gray-700 font-semibold hover:bg-white hover:text-black"
                  >
                    Add To Cart
                  </button>
                  {/* )} */}
