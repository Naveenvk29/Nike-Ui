...
const Hero = ({
  ...
  return (
    <div className="relative pt-8  w-auto pb-4 ">
      <div
        className="bg-gray-500 clip_path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto
      absolute top-0 right-0 left-0 z-10 opacity-100"
      ></div>
      <div className="relative opacity-100 z-20 flex flex-col   items-center pt-24">
        ...
        <button className="mt-4 border  border-slate-300 px-3  text-gray-900 hover:bg-gray-500 hover:text-cyan-50 shadow-lg rounded-lg font-medium text-xl ">
          {btntext}
        </button>
        ...
        <div className="">
          <img
            className="w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] rotate-[-25deg] transition-all ease-in-out hover:rotate-0 cursor-pointer mt-8 "
            src={img}
            alt=""
          />
        </div>
